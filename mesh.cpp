...
{
	Mesh::InitMesh(OBJModel(fileName).ToIndexedModel());
}
	...
	Transform transform)
{
	...
	glm::vec4 v0(vertices[indeces[0]].x, vertices[indeces[0]].y, vertices[indeces[0]].z, 1);
	glm::vec4 v1(vertices[indeces[1]].x, vertices[indeces[1]].y, vertices[indeces[1]].z, 1);
	glm::vec4 v2(vertices[indeces[2]].x, vertices[indeces[2]].y, vertices[indeces[2]].z, 1);
	v0 = model * v0;
	v1 = model * v1;
	v2 = model * v2;
...
std::vector<glm::vec3> Mesh::GetMouseIntersections(glm::vec3 rayOrigin, glm::vec3 rayVector, std::vector<int>& intersectionIndeces, Transform transform)
{
